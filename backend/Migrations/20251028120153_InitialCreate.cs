        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    TotalReadingPages = table.Column<int>(type: "integer", nullable: false),
                    AvgReadingPerDay = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookTagAssignments", x => new { x.BookId, x.TagId });
                    table.ForeignKey(
                        name: "FK_BookTagAssignments_BookTags_TagId",
                        column: x => x.TagId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadingTargets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReadingTargets_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReadingTargets_TargetLevels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "TargetLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Notes_ReadingSessions_SessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReadingProgresses_ReadingTargets_TargetId",
                        column: x => x.TargetId,
                        principalTable: "ReadingTargets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingProgresses_TargetId",
                table: "ReadingProgresses",
                column: "TargetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingTargets_BookId",
                table: "ReadingTargets",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_ReadingTargets_LevelId",
                table: "ReadingTargets",
                column: "LevelId");
        }
