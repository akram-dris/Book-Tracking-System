...
namespace BookTrackingSystem.Services
{
    public class RecommendationService : IRecommendationService
    {
        ...
        public async Task<Result<IEnumerable<RecommendationDto>>> GetRecommendationsAsync()
        {
            try
            {
                ...
                return Result<IEnumerable<RecommendationDto>>.Success(result);
            }
            catch (Exception ex)
            {
                return Result<IEnumerable<RecommendationDto>>.Failure($"An error occurred while retrieving recommendations: {ex.Message}");
            }
        }
    }
}
